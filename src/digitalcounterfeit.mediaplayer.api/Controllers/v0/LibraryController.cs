...
//        //[HttpGet]
//        //public async Task<ActionResult<LibraryModel>> GetByIdAsync([FromQuery] Guid? id, [FromQuery] Guid? userId)
//        //{
//        //    var library = 
//        //            id.HasValue ?
//        //        await _libraryRepository.GetByIdAsync(id.Value) :
//        //            userId.HasValue ?
//        //        await _libraryRepository.GetByUserIdAsync(userId.Value) :
//        //            null;
